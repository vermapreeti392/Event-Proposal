              ...
              <div className="modalContent">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                  <div>
                    ...
                    <select id="code-select" onChange = {(e)=>{setPlace(e.target.value)}} defaultValue={place}>
                  ...
                  <div>
                    ...
                    <select id="code-select" onChange = {(e)=>{setProposalType(e.target.value)}} defaultValue={proposalType}>
                      <option value="Select">Select</option>
                  ...
                  <div>
                    ...
                    <select id="code-select" onChange = {(e)=>{setEventType(e.target.value)}} defaultValue={eventType}>
                      <option value="Select">Select</option>
